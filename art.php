...
if(isset($_SESSION['success'])){
    ...
    $queryread = "SELECT * FROM bfb_acts WHERE genre = 'art'";
...
<div class="ui container"  >  
    ...
    <?php
      ...
      $query = "SELECT bfb_acts.img, bfb_acts.id, bfb_acts.act_name, bfb_acts.genre, bfb_reviews.comment FROM bfb_acts INNER JOIN bfb_reviews ON bfb_acts.id=bfb_reviews.act_id WHERE genre='art'";
