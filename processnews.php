<?php
    ...
    if($errorflag==1){
        $insertquery = "UPDATE bfb_news SET headline='$headline', content='$content' WHERE id='$editid'";
        
    }else{
        move_uploaded_file($filetemp,"../img/$filename");
        $insertquery = "UPDATE bfb_news SET img='$filename', headline='$headline', content='$content' WHERE id='$editid'";
    }
