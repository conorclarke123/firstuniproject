<?php
    ...
    if($errorflag==1){
        $insertquery = "INSERT INTO bfb_acts (act_name, act_details, dateofperformance, genre, venue) VALUES ('$actname', '$actdetails', '$date', '$genre', '$venue') ";
        
    }else{
        move_uploaded_file($filetemp,"../img/$filename");
        $insertquery = "INSERT INTO bfb_acts (img, act_name, act_details, dateofperformance, genre, venue) VALUES('$filename','$actname', '$actdetails', '$date', '$genre', '$venue' )";
    }
