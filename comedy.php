...
if(isset($_SESSION['success'])){
    ...
    $queryread = "SELECT * FROM bfb_acts WHERE genre = 'comedy'";
    ...
    echo"
      ...
      <div class='row'>
        ...
        <div class='six wide right floated column'>
          <img src='img/$img' class='ui large bordered rounded image' width='75%'>
        </div>
      </div>";
...
<h4>Previous Reviews</h4>
    ...
    <?php
      ...
      $query = "SELECT bfb_acts.img, bfb_acts.id, bfb_acts.act_name, bfb_acts.genre, bfb_reviews.comment FROM bfb_acts INNER JOIN bfb_reviews ON bfb_acts.id=bfb_reviews.act_id WHERE genre='comedy'";
